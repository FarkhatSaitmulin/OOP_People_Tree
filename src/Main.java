...
public class Main {
    public static void main(String[] args) {
        ...
        FamilyTree<Human> familyIvanovih = new FamilyTree<>();
        new Presenter(view, familyIvanovih);
        view.start();
...
//
//
////        family1.getHumanList().sort(new ui.ComparatorByName());
////
////        System.out.println(family1);
////
////        family1.getHumanList().sort(new ui.ComparatorByBirthday());
//
